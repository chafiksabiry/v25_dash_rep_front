                    ...
                    {scripts.length > 0 ? (
                      replicas.length > 0 ? (
                        replicas.map((item: any, idx: number) => (
                          <div 
                            key={idx} 
                            className={`group/replica relative flex gap-2.5 p-3 rounded-xl border transition-all duration-300 ${
                              item.actor === 'agent' 
                                ? 'bg-indigo-500/10 border-indigo-500/15 ml-4' 
                                : 'bg-emerald-500/10 border-emerald-500/15 mr-4'
                            }`}
                          >
                            <div className={`mt-0.5 p-1 rounded-md h-fit shrink-0 ${
                            ...
                            <div className="space-y-0.5 flex-1 min-w-0">
                              <div className="flex items-center justify-between">
                                ...
                                <button 
                                  ...
                                  className="opacity-0 group-hover/replica:opacity-100 transition-opacity p-0.5 bg-white/5 hover:bg-white/10 rounded text-slate-400 hover:text-white shrink-0"
                        ...
                        <div className="text-center py-6 bg-slate-950/20 rounded-xl border border-dashed border-white/5">
