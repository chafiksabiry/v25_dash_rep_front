...
ENV VITE_API_URL=https://prod-api-rep-dashboard.harx.ai
ENV VITE_CALLS_API_URL=https://prod-api-dash-calls.harx.ai
ENV VITE_DASHBOARD_COMPANY_API_URL=https://prod-api-dashboard.harx.ai/api
ENV VITE_BACKEND_URL_GIGS=https://prod-api-gigsmanual.harx.ai/api
...
ENV VITE_API_URL_AI_MESSAGES=https://prod-api-messages-service.harx.ai/api
ENV VITE_API_URL_CALL=https://prod-api-dash-calls.harx.ai
ENV VITE_REP_API_URL=https://prod-api-repcreationwizard.harx.ai
ENV VITE_AUTH_API_URL=https://prod-api-registration.harx.ai/api
ENV VITE_FRONT_URL=https://rep-dashboard.harx.ai/
ENV VITE_DASH_COMPANY_BACKEND=https://prod-api-dashboard.harx.ai/api
